    ...
    <div class="container">
        <div class="row">
            <div class="block" style="margin: auto; width: 50%">
                <form id="join" action="join.do" method="post" onsubmit="return validate()">
...
<!-- 								  <input type="text" style="width: 200px;" id="email" name="email"class="form-control" placeholder="xxxxx.com"> -->
                    ...
                    <div class="form-group">
                        전화번호 <input type="text" name="phone" maxlength="11" pattern="[0-9]{10}[0-9]?" class="form-control" required="required" placeholder="'-'를 뺀 휴대전화 번호 10~11자리를 입력해주세요.">
                        <input type="hidden" name="owners" class="form-control" value="일반회원">
                    </div>
