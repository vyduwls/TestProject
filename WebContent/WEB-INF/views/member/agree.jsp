...
<section id="contact-form">
    <div class="container">
        <div class="row">
            <div class="block" style="margin: auto; width: 50%; height: 50%">

                <form name="joinform" method="post" action="agree2.do">
                    <div>
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                        ...
                        <input id="ck" name="ckbox" type="checkbox" required="required"> 위의 약관에 동의 합니다.<br />
                        <br />
                    </div>
                    <div>
                        <pre class="pre-scrollable">
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
                    ...
                    <button type="submit">회원가입하러가기</button>
                </form>
            </div>
<!--             <div style="margin-left: 270px"> -->
<!--                 <a href="join.do"> <img src="../img/member.png" alt border="0"> -->
<!--                 </a> <a href="confirm.do"> <img src="../img/owner.png" alt border="0"> -->
<!--                 </a> -->
<!--             </div> -->
        </div>
    ...
    <div id="contact-box" class="row">
        <div class="col-md-6 col-sm-12">
            <div class="block" style="margin: auto; width: 100%; margin-left: 67%">
