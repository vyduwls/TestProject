...
<link rel="stylesheet" href="${pageContext.request.contextPath}/store/store.css">
...
<script src="${pageContext.request.contextPath}/js/vender/jquery-1.10.2.min.js"></script>
